...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    result = []
    for i in range(1, 11):
        result.append(make_averaged(roll_dice, total_samples)(i, dice))
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    sim = score + hefty_hogs(score, opponent_score)
    if hog_pile(sim, opponent_score):
        return 0
    sim += hog_pile(sim, opponent_score)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score > opponent_score:
        if score > 85:
            return hefty_hogs_strategy(score, opponent_score, 5, 6)
        return hefty_hogs_strategy(score, opponent_score, 8, 4)
    return hefty_hogs_strategy(score, opponent_score, 8, 6)  
    # END PROBLEM 12
```